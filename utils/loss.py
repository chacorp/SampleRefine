...
class GANLoss(nn.Module):
    def __init__(self, gan_mode, target_real_label=1.0, target_fake_label=0.0,
        ...
        if not gan_mode in ['ls', 'original', 'w', 'hinge']:
...
class VGGLoss(nn.Module):
    """
        https://github.com/NVIDIA/pix2pixHD/blob/5a2c87201c5957e2bf51d79b8acddb9cc1920b26/models/networks.py#L112
    """
    def __init__(self, gpu_ids=None, device='cpu'):
